...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBookNotAvailableException(IllegalArgumentException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleNoHandlerFound(NoResourceFoundException ex, HttpServletRequest request) {

        ErrorResponse error = ErrorResponse.of(
                HttpStatus.NOT_FOUND.value(),
                "Not Found",
                "The API endpoint you requested does not exist." + ex.getMessage(),
                request.getRequestURI()
        );
